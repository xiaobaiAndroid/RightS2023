package com.android.launcher.kb;
 ...
 */
public class SoftKeyboardNumView extends View {

    private static final String TAG = "SoftKeyboardView";

    public SoftKeyboardNumView(Context context) {
        super(context);
        init(context, null);
    }

    public SoftKeyboardNumView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SoftKeyboardNumView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnKeyBoardAnimListener {
        public boolean onKeyBoardAnim(final SoftKeyboardNumView softKeyboardView, final SoftKey oldSoftkey, final SoftKey targetSoftKey);
    }
