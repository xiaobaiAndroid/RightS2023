...
public class SwitchButton extends View implements Checkable {
    ...
    //是否响应触摸
    private boolean isActivateTouch;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        isActivateTouch = optBoolean(typedArray,
                 R.styleable.SwitchButton_sb_is_touch,
                 true);
    ...
    public void setChecked(boolean checked, boolean isEnableEffect) {
        if(checked == isChecked()){
            postInvalidate();
            return;
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if(!isEnabled() || !isActivateTouch){return false;}
